...
function NormalPage() {
  ...
  useEffect(() => {
    ...
    if (subscribe) {
      ...
      setNextJS(Math.random().toString(16).substr(-6));
      SetTypeScript(Math.random().toString(16).substr(-6));
    }
        ...
        <section className="section_normal-3">
          ...
          <div className="about_container">
            <div className="about_text">
              <p className="txt_one">
                I caught fire coding. For most people, coding doesn't sound very
                interesting. For me, it's <span>passion</span>.
              </p>
              <p className="txt_two">
              ...
              <p className="txt_three">
                I'm very ambitious <span>Full-Stack</span> Web Developer.
              ...
              <p className="txt_four">
                ...
                learner,supportive of other people, and someone who is prepared
                to go above and beyond what is required to ensure that my
                employer always stays one step ahead of its competitors
              </p>
            </div>
            <hr />
          ...
          <div className="skills_container">
            ...
            <div className="skills_text_middle">
              <ul>
                ...
                <li>
                  <div style={{ backgroundColor: `#${nextJS}` }}>Next.JS</div>
                </li>
                <li>
                  <div style={{ backgroundColor: `#${typeScript}` }}>
                    TypeScript
                  </div>
                </li>
                <li>
                ...
                <li>
                  <div style={{ backgroundColor: `#${figmaColor}` }}>Figma</div>
                </li>
                <li>
